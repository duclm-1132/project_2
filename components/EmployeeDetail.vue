		...
		<div class="modal__container">
			...
			<div class="modal--body">
				<div class="row col-full flex">
					...
					<div class="col-half flex">
						<div class="form-group col-half">
							<label for="dateOfBirth" class="text-label"
								>Ngày sinh</label
							>
							<input
								id="dateOfBirth"
				...
				<div class="row col-full flex">
					<div class="col-half mg-r20">
						<div class>
							<label class="text-label" for="department"
								>Đơn vị</label
							>
							<select
								id="department"
					...
					<div class="col-half flex">
						<div class="form-group col-6">
							<label for="identityNumber" class="text-label"
								>Số CMND</label
							>
							<input
								id="identityNumber"
						...
						<div class="col-4">
							<label for="identityDate" class="text-label"
								>Ngày cấp</label
							>
							<input
								id="identityDate"
				...
				<div class="row col-full flex">
					...
					<div class="col-half">
						<div class="form-group col-full">
							<label for="identityPlace" class="text-label"
								>Nơi cấp</label
							>
							<input
								id="identityPlace"
				...
				<div class="row col-ful flex">
					...
					<div class="row col-5 mg-r8">
						<div class="form-group col-full">
							<label for="telephoneNumber" class="text-label"
								>ĐT cố định</label
							>
							<input
								id="telephoneNumber"
				...
				<div class="row col-ful flex">
					<div class="row col-5 mg-r8">
						<div class="form-group col-full">
							<label for="bankAccount" class="text-label"
					...
					<div class="row col-5 mg-r8">
						<div class="form-group col-full">
							<label for="bankName" class="text-label"
								>Tên ngân hàng</label
							>
							<input
								id="bankName"
					...
					<div class="row col-5">
						<div class="form-group col-full">
							<label for="branchBankName" class="text-label"
								>Chi nhánh</label
							>
							<input
								id="branchBankName"
			...
			<div class="modal--footer">
				...
				<div class="footer-right">
					<button class="btn btn-save" @click="btnSaveClick">
						Cất
					</button>
...
export default {
	...
	props: {
		...
		// Đối tượng nhân viên được truyền từ EmployeeList sang
